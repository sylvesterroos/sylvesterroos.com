...
import Mutation from "../../components/Mutation.astro";
import StringEvolution from "../../components/StringEvolution.astro";
import TournamentSelection from "../../components/TournamentSelection.astro";
...
<img
  class="petri-logo"
  src="https://raw.githubusercontent.com/sylvesterroos/petri/master/assets/logo.svg"
  alt="Petri logo"
/>
...
Play around with the tournament sizes to get a feel for how it works.
